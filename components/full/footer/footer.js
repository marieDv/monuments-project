...
scriptImageFullWidthVarHeight.src = '/components/base/image-full-width-var-height/image-full-width-var-height.js';
...
scriptImgSixColumnsVarHeight.src = '/components/base/image-six-columns-var-height/image-six-columns-var-height.js';
...
class Footer extends HTMLElement {
  constructor() {
    ...
    if (this.getAttribute('base') === "false") {
      ...
      styleFooter = '<link rel="stylesheet" href="/../../components/full/footer/footer.css">';//../../components/footer/footer.css
      if (currentTemplate === "Visualization-Almendra-Display") {
