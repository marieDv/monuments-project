...
const H3Headlines4Column2ColumnImageBodyTextTemplate = document.createElement("template");
H3Headlines4Column2ColumnImageBodyTextTemplate.innerHTML = allStyles + `
...
class H3Headlines4Column2ColumnImageBodyText extends HTMLElement {
  constructor() {
    super();
    setupComponent(this, H3Headlines4Column2ColumnImageBodyTextTemplate);
...
window.customElements.define('halves-h3-headlines-4column-2column-image-body-text', H3Headlines4Column2ColumnImageBodyText);
